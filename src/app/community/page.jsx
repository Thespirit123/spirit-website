...
const Page = () => {
  ...
  const handleClick = () => {
    // window.location.href = "https://chat.whatsapp.com/IZ9kgz1qkJW4wpDZl36KwR";
    window.open("https://chat.whatsapp.com/IZ9kgz1qkJW4wpDZl36KwR", "_blank");
  };
  const waysToEarnDiv = [
    ...
    <div style={{paddingTop:"60px"}}>
      ...
      <div  className='CommunityHeroDiv'>
        ...
        <div  className='communityHeroButtonDiv'>
          <a href="/utility-payment"><div  className='communityHeroButton NowButton1'>Airtime</div></a>
...
<div className='NLN'>
    ...
    <div className='ButtonT'>
       <a href="https://t.me/Thespiritupdates" target="_blank" rel="noopener noreferrer">
...
<span>Join Telegram Channel</span>
          ...
          <div className='ButtonT'>
        {/* <a href="https://chat.whatsapp.com/IZ9kgz1qkJW4wpDZl36KwR" > */}

         <div className="JoinOurCommunity4" data-aos="fade-up" data-aos-delay="100"   role="button"
  tabIndex={0}
  onClick={handleClick}
