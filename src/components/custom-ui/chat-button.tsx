...
const CHAT_LINKS = [
    {
        label: "Get in Touch",
        href: "https://wa.me/2349035745258?text=Hi%2C%20I%27d%20like%20to%20get%20in%20touch%20with%20Spirit%20Media",
    },
    {
    ...
    return (
        <DropdownMenu open={open} onOpenChange={setOpen}>
            <DropdownMenuTrigger asChild>
                <button
                    className="z-50 bottom-6 right-6 bg-[#00C2D1] hover:bg-[#0099a8] transition-colors rounded-full w-16 h-16 flex items-center justify-center shadow-lg focus:outline-none"
