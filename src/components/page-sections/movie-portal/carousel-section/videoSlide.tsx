...
const getPlanId = (platform: Platform, isAnime: boolean) => {
  if (platform === "android")
    return isAnime ? "android-anime" : "android-movies";
  return "ios-movies";
};
  ...
  ({ appType, price, features, videoUrl, onVideoEnd }: VideoSlideProps) => {
    ...
    const handleGetAccess = () => {
      const planId = getPlanId(
        appType.platform,
        appType.name.toLowerCase().includes("anime")
      );
      handleOpenPayment(planId);
    };
